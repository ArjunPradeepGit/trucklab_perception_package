...
'''
Script: Object detection activation - at Lidar level
...
def main(args):
    ...
    # Activating: Object Detection LiDAR
    node_objectdetection = "node_objectdetection.py"
    run_lidar_file_in_new_terminal(node_name=node_objectdetection, dc_id=args.dc_id, unit_type=args.unit_type, unit_id=args.unit_id, lidar_id=args.lidar_id)
