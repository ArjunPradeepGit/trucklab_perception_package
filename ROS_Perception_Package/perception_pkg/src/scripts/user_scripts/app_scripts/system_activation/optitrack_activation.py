...
def main(args):
    ...
    if args.unit_type == 'v':
        ...
        raise ValueError("Received input for unit_type other than 'v'. Optitrack though part of infrastructure, is activated for each vehicle as of now!")
    ...
    if config_info["ACTIVATE_OPTITRACK"]:
        # print(config_info["ACTIVATE_OPTITRACK"])
        node_preprocessor = "node_optitrack_preprocessor.py"
...
if __name__ == "__main__":
    ...
    parser.add_argument('-unit_type', '--unit_type', help='Provide unit type, Vehicle-v or Infrastructure-i', type=str, default="i")
