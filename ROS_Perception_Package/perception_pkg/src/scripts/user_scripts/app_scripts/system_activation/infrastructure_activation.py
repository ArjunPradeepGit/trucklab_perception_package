...
'''
Script: Infrastructure activation
...
def main(args):
    ...
    node_define_sensors = "node_infrastructure_definition.py"
    run_file_in_new_terminal(node_name=node_define_sensors, dc_id=args.dc_id, unit_id=args.unit_id)


if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="node infrastructure activation")
