...
def main(args):
    ...
    if args.unit_type == 'v':
        ...
        raise ValueError("Received input for unit_type other than 'v'. Odometry is defined only for vehicle!")
    ...
    node_preprocessor = "node_odometry_preprocessor.py"
