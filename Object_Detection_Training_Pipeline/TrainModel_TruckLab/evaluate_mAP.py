...
from yolov3_files.yolov3 import Create_Yolo
from yolov3_files.utils import image_preprocess, postprocess_boxes, nms, read_class_names
...
if __name__ == '__main__':
    ...
    yolo.load_weights(YOLOV3_TRUCKLAB_WEIGHTS)
