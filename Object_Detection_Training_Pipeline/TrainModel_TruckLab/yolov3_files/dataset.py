...
from TrainModel_TruckLab.yolov3_files.utils import read_class_names, image_preprocess
from TrainModel_TruckLab.yolov3_files.yolov3 import bbox_iou
from TrainModel_TruckLab.yolov3_files.configs import *
        ...
        for annotation in annotations:
            ...
            for i, one_line in enumerate(line):
                if not one_line.replace(",","").isnumeric():
                    ...
                    image_path += ROOT_DIR + "\\" + DATA_FOLDER + "\\" + one_line
                else:
                    index = i
                    break
            ...
            if self.batch_count < self.num_batchs:
                while num < self.batch_size:
                    ...
                    try:
                        ...
                        print("IndexError, something wrong with", annotation[0], "please check !")
